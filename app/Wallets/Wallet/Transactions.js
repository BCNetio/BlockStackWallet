        ...
        <Scroll className="scroll-wrapper dark">
          {this.props.transactions && this.props.transactions.length ? (
            ...
            <div style={{ padding: "20px" }}>
              the blockchain explorer temporary unavailable. Your assets are
              absolutely safe. Please try to repeat you request a bit later.
...
const mapDispatchToProps = dispatch => ({
  fetchTransactions: (addres, offset) =>
    dispatch(actions.fetchTransactions(addres, offset))
});
