...
const config = {
  btc: {
    balance: address =>
      `https://insight.bitpay.com/api/addr/${address}/balance`,
  ...
  bch: {
    balance: address =>
      `https://bch-insight.bitpay.com/api/addr/${addrToBitpayFormat(
        address
      )}/balance`,
    normalizationBlance: response => response,
    tx: address =>
      `https://bch-insight.bitpay.com/api/txs/?address=${addrToBitpayFormat(
        address
      )}`,
    utxo: address =>
      `https://bch-insight.bitpay.com/api/addr/${addrToBitpayFormat(
  ...
  doge: {
    ...
    tx: address =>
      `https://api.blockcypher.com/v1/doge/main/addrs/${address}/full?token=${
        apiKeys.blockcypher
      }`,
  ...
  ltc: {
    balance: address =>
      `https://insight.litecore.io/api/addr/${address}/balance`,
    normalizationBlance: response => toBTC(response),
  ...
  zec: {
    balance: address =>
      `https://explorer.testnet.z.cash/api/addr/${address}/balance`,
    normalizationBlance: response => response,
    tx: address =>
      `https://explorer.testnet.z.cash/api/txs/?address=${address}`,
  ...
  dcr: {
    balance: address =>
      `https://mainnet.decred.org/api/addr/${address}/balance`,
    normalizationBlance: response => response,
  ...
  dash: {
    balance: address =>
      `https://insight.dash.org/insight-api/addr/${address}/balance`,
    normalizationBlance: response => toBTC(response),
    tx: address =>
      `https://insight.dash.org/insight-api/txs/?address=${address}`,
    utxo: address =>
