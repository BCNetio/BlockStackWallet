...
export const Snackbar = styled.div`
    ...
    right: 0;
    margin: auto;
    background: ${props => props.base ? '#F1F2FA' : props.alert ? '#C11E0F' : props.confirm ? '#7AC231' : 'white'};
    p{
        margin: 0;
        font-size: 14px;
    ...
    button{
        ...
        height: 10px;
        margin-left: 10px;
        background: transparent url(${props => props.base ? IconCrossGrey : IconCrossWhite}) no-repeat center;
    }
`;
